  ...
  return (
    <>
      ...
      >
        <div className="sticky top-80">
          <p className="text-lg md:text-5xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
            Shaping Tomorrow with Our Cutting-Edge Tech Stack
          </p>
          <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
            Our secret sauce? A powerful mix of tools and technologies that turn
            ideas into reality.
          </p>
          <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
            <p className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
              Tech Mastery
            </p>
          </div>
          <svg
          ...
          >
            <path
              ...
              stroke-dasharray="0.21723698207310269px 1px"
            ></path>
            <path
              ...
              pathLength="1"
              stroke-dashoffset="0px"
              stroke-dasharray="0.11939160483224051px 1px"
            ></path>
            <path
              ...
              pathLength="1"
              stroke-dashoffset="0px"
              stroke-dasharray="0.021546227591378347px 1px"
            ></path>
            <path
      ...
      <div class="bg-black py-20">
        <div class="relative z-10 mt-20 space-y-24 px-4">
          <div>
            <h2 class="text-center text-3xl font-bold mb-16">
              <span class="bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">
                Development Technologies
              </span>
            </h2>
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div class="group relative flex flex-col items-center justify-center p-6 rounded-lg bg-[#0a1119]/80 hover:bg-[#0a1119] transition-transform duration-300 hover:scale-105">
                ...
                <span class="absolute -bottom-6 left-1/2 -translate-x-1/2 text-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-xs whitespace-nowrap">
                  Next.js
                </span>
              </div>
              <div class="group relative flex flex-col items-center justify-center p-6 rounded-lg bg-[#0a1119]/80 hover:bg-[#0a1119] transition-transform duration-300 hover:scale-105">
